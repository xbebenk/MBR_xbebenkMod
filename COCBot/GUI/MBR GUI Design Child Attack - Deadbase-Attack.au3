...
; Attack with
Global $g_hCmbDBAlgorithm = 0, $g_hChkDBDropEmptySiege = 0
Global $g_hPicDBWardenAttack = 0, $g_hPicDBDropCC = 0
Global $g_hCmbDBWardenMode = 0, $g_hCmbDBSiege = 0
	...
	Local $x = 25, $y = 40
		...
		$y += 2
			$g_hCmbDBAlgorithm = GUICtrlCreateCombo("", $x, $y, 135, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
				_GUICtrlSetTip(-1, "")
				GUICtrlSetData(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Attack", "Cmb-Algorithm_Item_02", "SmartFarm Attack") & "|" & _
								   GetTranslatedFileIni("MBR GUI Design Child Attack - Attack", "Cmb-Algorithm_Item_04", "Scripted Attack"), _ 
								   GetTranslatedFileIni("MBR GUI Design Child Attack - Attack", "Cmb-Algorithm_Item_02", -1))
        ...
        $x += 32
            $g_hCmbDBWardenMode = GUICtrlCreateCombo("", $x, $y, 100, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
		...
		$x += 32
			$g_hCmbDBSiege = GUICtrlCreateCombo("", $x, $y, 100, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
