...
Func CreateBotTab()
	...
	$g_hGUI_LOG_SA = _GUICreate("", 215, 95, 225, 335, BitOR($WS_CHILD, 0), -1, $g_hGUI_BOT)
...
Func CreateBotSwitchAccLog()
	...
	$g_hTxtSALog = _GUICtrlRichEdit_Create($g_hGUI_LOG_SA, "", $x, $y, 215, 95, BitOR($ES_MULTILINE, $ES_READONLY, $WS_VSCROLL, $WS_HSCROLL, $ES_UPPERCASE, $ES_AUTOHSCROLL, $ES_AUTOVSCROLL, $ES_NUMBER, 0x200), $WS_EX_STATICEDGE)
