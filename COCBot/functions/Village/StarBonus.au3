...
Func StarBonus()
	...
	If _CheckPixel($aWindowChk1, $g_bCapturePixel, Default, "Starbonus1") And _CheckPixel($aWindowChk2, $g_bCapturePixel, Default, "Starbonus2") Then
		...
		SetDebugLog("Okay btn chk-#1: " & _GetPixelColor(354, 442, $g_bCapturePixel) & ", #2: " & _GetPixelColor(354 + 145, 442, $g_bCapturePixel) & ", #3: " & _GetPixelColor(354 + 55, 442 + 16, $g_bCapturePixel) & ", #4: " & _GetPixelColor(355 + 51, 442 + 23, $g_bCapturePixel), $COLOR_DEBUG)
