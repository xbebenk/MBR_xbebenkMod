...
Func GetButtonDiamond($sButtonName)
	...
	Switch $sButtonName
		...
		Case "ObjectButtons", "BoostOne", "BoostCT", "Upgrade", "Research", "Treasury", "RemoveObstacle", "CollectLootCart", "Pets", "Cancel", "MagicItem", "HeroBooks" ; Full size of object buttons at the bottom
