...
Func ReadConfig_600_6()
	...
	;Sell Magic Items
	IniReadS($g_bChkEnableSellMagicItem, $g_sProfileConfigPath, "MagicItems", "ChkSellMagicItems", False, "Bool")
	IniReadS($g_bChkSellBOF, $g_sProfileConfigPath, "MagicItems", "ChkSellBOF", False, "Bool")
	IniReadS($g_bChkSellBOB, $g_sProfileConfigPath, "MagicItems", "ChkSellBOB", False, "Bool")
	IniReadS($g_bChkSellBOS, $g_sProfileConfigPath, "MagicItems", "ChkSellBOS", False, "Bool")
	IniReadS($g_bChkSellBOH, $g_sProfileConfigPath, "MagicItems", "ChkSellBOH", False, "Bool")
	IniReadS($g_bChkSellBOE, $g_sProfileConfigPath, "MagicItems", "ChkSellBOE", False, "Bool")
	IniReadS($g_bChkSellShovel, $g_sProfileConfigPath, "MagicItems", "ChkSellShovel", False, "Bool")
	IniReadS($g_bChkSellWallRing, $g_sProfileConfigPath, "MagicItems", "ChkSellWallRing", False, "Bool")
	IniReadS($g_bChkSellPowerPot, $g_sProfileConfigPath, "MagicItems", "ChkSellPowerPot", False, "Bool")
	IniReadS($g_bChkSellResourcePot, $g_sProfileConfigPath, "MagicItems", "ChkSellResourcePot", False, "Bool")
	IniReadS($g_bChkSellTrainingPot, $g_sProfileConfigPath, "MagicItems", "ChkSellTrainingPot", False, "Bool")
	IniReadS($g_bChkSellBuilderPot, $g_sProfileConfigPath, "MagicItems", "ChkSellBuilderPot", False, "Bool")
	IniReadS($g_bChkSellCTPot, $g_sProfileConfigPath, "MagicItems", "ChkSellCTPot", False, "Bool")
	IniReadS($g_bChkSellHeroPot, $g_sProfileConfigPath, "MagicItems", "ChkSellHeroPot", False, "Bool")
	IniReadS($g_bChkSellResearchPot, $g_sProfileConfigPath, "MagicItems", "ChkSellResearchPot", False, "Bool")
	IniReadS($g_bChkSellSuperPot, $g_sProfileConfigPath, "MagicItems", "ChkSellSuperPot", False, "Bool")
	IniReadS($g_bChkSellROG, $g_sProfileConfigPath, "MagicItems", "ChkSellROG", False, "Bool")
	IniReadS($g_bChkSellROE, $g_sProfileConfigPath, "MagicItems", "ChkSellROE", False, "Bool")
	IniReadS($g_bChkSellRODE, $g_sProfileConfigPath, "MagicItems", "ChkSellRODE", False, "Bool")
	IniReadS($g_bChkSellROBG, $g_sProfileConfigPath, "MagicItems", "ChkSellROBG", False, "Bool")
	...
	IniReadS($g_bChkBBEndBattleOn2Stars, $g_sProfileConfigPath, "other", "ChkBBEndBattleOn2Stars", False, "Bool")
	...
	IniReadS($g_bChkHeroJourney, $g_sProfileConfigPath, "other", "SkipDT", False, "Bool")
	IniReadS($g_bEnableTournament, $g_sProfileConfigPath, "other", "EnableTournament", False, "Bool")
	IniReadS($g_bNoTournament, $g_sProfileConfigPath, "other", "NoTournament", False, "Bool")
...
Func ReadConfig_600_11()
	...
	IniReadS($g_bChkUpdateRequest, $g_sProfileConfigPath, "donate", "ChkUpdateRequest", False, "Bool")
	IniReadS($g_iCmbRequestTroop1, $g_sProfileConfigPath, "donate", "CmbRequestTroop1", 0, "int")
	IniReadS($g_iCmbRequestSpell1, $g_sProfileConfigPath, "donate", "CmbRequestSpell1", 0, "int")
	IniReadS($g_iCmbRequestSiege1, $g_sProfileConfigPath, "donate", "CmbRequestSiege1", 0, "int")
	IniReadS($g_iCmbRequestTroop2, $g_sProfileConfigPath, "donate", "CmbRequestTroop2", 0, "int")
	IniReadS($g_iCmbRequestSpell2, $g_sProfileConfigPath, "donate", "CmbRequestSpell2", 0, "int")
	IniReadS($g_iCmbRequestSiege2, $g_sProfileConfigPath, "donate", "CmbRequestSiege2", 0, "int")
	
	IniReadS($g_iRequestTroopQuantity1, $g_sProfileConfigPath, "donate", "RequestTroopQuantity1", 0, "int")
	IniReadS($g_iRequestSpellQuantity1, $g_sProfileConfigPath, "donate", "RequestSpellQuantity1", 0, "int")
	IniReadS($g_iRequestSiegeQuantity1, $g_sProfileConfigPath, "donate", "RequestSiegeQuantity1", 0, "int")
	IniReadS($g_iRequestTroopQuantity2, $g_sProfileConfigPath, "donate", "RequestTroopQuantity2", 0, "int")
	IniReadS($g_iRequestSpellQuantity2, $g_sProfileConfigPath, "donate", "RequestSpellQuantity2", 0, "int")
	IniReadS($g_iRequestSiegeQuantity2, $g_sProfileConfigPath, "donate", "RequestSiegeQuantity2", 0, "int")
...
Func ReadConfig_600_15()
	...
	Next
	IniReadS($g_bChkMinOreUpgrade, $g_sProfileConfigPath, "upgrade", "ChkMinOreUpgrade", False, "Bool")
	IniReadS($g_sTxtMinOreUpgrade, $g_sProfileConfigPath, "upgrade", "MinOreUpgrade", 2000, "int")
...
Func ReadConfig_600_28_DB()
	...
	IniReadS($g_iCmbDBUseArmy, $g_sProfileConfigPath, "search", "CmbDBUseArmy", 0, "int")
...
Func ReadConfig_600_29()
	...
	IniReadS($g_iDelayActivatePrince, $g_sProfileConfigPath, "attack", "delayActivatePrince", 10000, "int")
	IniReadS($g_iDelayActivateDuke, $g_sProfileConfigPath, "attack", "delayActivateDuke", 10000, "int")
