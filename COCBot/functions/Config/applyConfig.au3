...
Func ApplyConfig_600_11($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			GUICtrlSetState($g_hChkRequestRemoveImage, $g_bRequestRemoveImage ? $GUI_CHECKED : $GUI_UNCHECKED)
			; Request Type - Demen
		...
		Case "Save"
			...
			$g_bRequestRemoveImage = (GUICtrlRead($g_hChkRequestRemoveImage) = $GUI_CHECKED)
