...
Func ApplyConfig_600_6($TypeReadSave)
	...
	Switch $TypeReadSave
		Case "Read"
			...
			_GUICtrlComboBox_SetCurSel($g_hCmbFillIncorrectCombo, $g_iCmbFillIncorrectCombo)
		...
		Case "Save"
			...
			$g_iCmbFillIncorrectCombo = _GUICtrlComboBox_GetCurSel($g_hCmbFillIncorrectCombo)
