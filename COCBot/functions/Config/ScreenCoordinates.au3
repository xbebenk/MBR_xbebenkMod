...
Global $aIsGoldFull[4] = [660, 37, 0xE7C00D, 10] ; Main Screen Gold Resource bar is Full
Global $aIsElixirFull[4] = [660, 86, 0xC027C0, 10] ; Main Screen Elixir Resource bar is Full
...
Global Const $aIsAttackPage[4] = [18, 548 + $g_iBottomOffsetY, 0xcf0d0e, 20] ; red button "end battle" but left portion
