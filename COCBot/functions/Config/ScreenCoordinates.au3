...
Global $aSurrenderButton[4] = [70, 545, 0xC00000, 40] ; Surrender Button, Attack Screen
...
Global $aGreenArrowTrainTroops[2] = [308, 93]
Global $aGreenArrowBrewSpells[2] = [467, 93]
...
Global $aTreasuryWindow[4] = [689, 138, 0xFF8D95, 20] ; Redish pixel above X to close treasury window
...
Global Const $aPersonalChallengeCloseButton[4] = [826, 42, 0xFFFFFF, 20] ; Personal Challenge Window Close Button
